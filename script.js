...
document.getElementById("noBtn").addEventListener("click", function () {
  switch (noButtonState) {
    ...
    case 3:
      document.getElementById("noBtn").innerHTML = "¿Te gusta el queso? 😁";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
    ...
    case 16:
      document.getElementById("noBtn").innerHTML =
        "No me iré sin un SI como respuesta 😤";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "285px";
      document.getElementById("siBtn").style.padding = "175px 290px";
    ...
    case 18:
      document.getElementById("noBtn").innerHTML = "Quieres que me vaya?😭";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";

      // Hacer que el botón "Sí" crezca
      document.getElementById("siBtn").style.fontSize = "295px";
      document.getElementById("siBtn").style.padding = "185px 310px";
    ...
    case 19:
      document.getElementById("noBtn").innerHTML =
        "Seguiré preguntando en bucle hasta que digas que si 😁";
      document.getElementById("noBtn").style.backgroundColor = "#F1330A";
      // Vuelve al estado 0
      noButtonState = 16;
      break;
